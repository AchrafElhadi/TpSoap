...
public class ObjectFactory {
    ...
    private final static QName _Mycompte_QNAME = new QName("http://ws/", "Mycompte");
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "Mycompte")
    public JAXBElement<Compte> createMycompte(Compte value) {
        return new JAXBElement<>(_Mycompte_QNAME, Compte.class, null, value);
    }
